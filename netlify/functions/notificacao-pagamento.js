...
async function processarPagamento(event) {
    ...
    try {
        ...
        console.log("Webhook recebido. Verificando tipo...");

        // A LÓGICA FINAL E MAIS SIMPLES: PROCESSAR APENAS O EVENTO 'payment'
        if (body.type === 'payment') {
            ...
            // Ignora qualquer outro tipo de evento, como 'merchant_order'
