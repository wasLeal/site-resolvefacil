...
async function addContactToList(apiKey, email, name) {
  ...
  const LIST_ID = 2; // <--- TROQUE ESTE NÚMERO PELO ID DA SUA LISTA
  // ===================================================================
  ...
  const options = {
    ...
    body: JSON.stringify({
      ...
      listIds: [LIST_ID] // Adiciona o contato à lista especificada
    })
  };
...
exports.handler = async function(event) {
  ...
  try {
    ...
    const emailBody = {
      sender: {
        name: 'ResolveFácil',
        // IMPORTANTE: Use um e-mail do seu domínio verificado
        email: 'contato@resolvefacil.online' 
      },
